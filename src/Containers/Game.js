...
class Game extends Component{
    ...
    playCard(nDrinks, id, card, type_card){
        ...
        if (drink_users.length > 0) {
            if (type_card) {
                alert("Drink "+ (nDrinks + 1) + " drinks: " + drink_users.join(", "))    
            }else{
                alert("Give out "+ (nDrinks + 1) + " drinks: " + drink_users.join(", "))
            }
    ...
    render(){
        return(
            ...
            <Layout className="layout">
                <Header>
                    <Menu theme="dark" mode="horizontal" style={{ lineHeight: '64px' }}>
                        <Menu.Item><img alt="cups" src={logo} height="60px" /></Menu.Item>
                        <Menu.Item key="1"><Link to="/statistics">End Game</Link></Menu.Item>
                    </Menu>
                </Header>
            </Layout>
            <Row style={{paddingLeft : 20}}>
                ...
                <br />
                <Card style={{ backgroundColor:"#001529", color:"#8C8C8C", top:-10, height:60, width: 300, textAlign :"center", fontWeight: "bold" }}>Players</Card>
                <List
